...
class MaestroController:
    ...
    # which has precedence over these values.  Use the Maestro Control Center to
    # configure ranges that are saved to the controller.
    # Use setRange for software controllable ranges.
